...
describe('Leaderboard Component', () => {
  ...
  it('displays rank icons correctly', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getAllByTestId('trophy-icon')).toHaveLength(2) // Trophy appears in header and table
    })
  })
  ...
  it('shows last active time', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getAllByText(/ago/)).toHaveLength(10) // 10 users in mock data
    })
  })
  ...
  it('shows exam and certification counts', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getAllByText('8')).toHaveLength(3) // Multiple users with 8 certifications
    })
  })
})
