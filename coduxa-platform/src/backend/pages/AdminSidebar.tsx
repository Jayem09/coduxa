// src/backend/pages/AdminSidebar.tsx
...
const menuItems = [
  { title: "Admin Dashboard", icon: Shield, href: "/dashboard/admin" },
    ...
    <Sidebar>
      <SidebarHeader className="p-4">
        <div className="flex items-center gap-2">
          <div className="text-lg font-bold">Coduxa</div>
        </div>
        <div className="mt-4 p-3 bg-muted rounded-lg">
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium truncate">John Dinglasan</p>
              <p className="text-xs text-muted-foreground truncate">
                johndinglasan12@gmail.com
              </p>
            </div>
          </div>
